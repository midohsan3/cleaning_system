          ...
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">Edit /
                <strong class="text-primary small">{{$nationality->name_en}}</strong>
              </h3>

              <div class="nk-block-des text-soft">
                <ul class="list-inline">
                  <li>Created At: <span
                      class="text-base">{{ date('d M Y h:i A',strtotime($nationality->created_at)) }}</span></li>
                </ul>
              </div>
            </div>
          ...
          <div class="card card-preview">
            <div class="card-inner">
              <div class="preview-block">
                ...
                <form action="{{route('admin.nationality.update')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control form-control-sm" id="nameEn" name="nameEn"
                            placeholder="English Name Here" value="{{ old('nameEn',$nationality->name_en) }}"
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                          <input type="text" class="form-control form-control-sm" id="nameAr" name="nameAr"
                            placeholder="Arabic Name Here" value="{{ old('nameAr',$nationality->name_ar) }}"
                            autocomplete="off" />
                          @error('nameAr')
                          <span class="bg-danger text-white" role="alert">{{ $message }}</span>
                          @enderror
