        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">Nationality /
              ...
              <div class="nk-block-des text-soft">
                <ul class="list-inline">
                  <li>Submitted At: <span
                      class="text-base">{{ date('d M, Y', strtotime($nationality->created_at)) }}</span>
                  </li>
                </ul>
              </div>
                    ...
                    <div class="profile-ud-list">
                      ...
                      <div class="profile-ud-item">
                        <div class="profile-ud wider">
                          ...
                          <span class="profile-ud-value">{{ $nationality->name_ar }}</span>
                        </div>
                      </div>
                      ...
                      <div class="profile-ud-item">
                        <div class="profile-ud wider">
                          ...
                          <span
                            class="profile-ud-value">{{ date('M-d-Y  h:m:a',strtotime($nationality->created_at)) }}</span>
                        </div>
                      </div>
