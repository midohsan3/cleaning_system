        ...
        <div class="nk-block-head">
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">Booking Schedule
                <strong class="text-primary small"></strong>
              </h3>
...
<div class="modal fade" tabindex="-1" id="editEventPopup">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('admin.booking.update') }}" id="editEventForm" class="form-validate is-alter">
          <div class="row gx-4 gy-3">
            <div class="col-12">
              <div class="form-group">
                ...
                <div class="row gx-2">
                  <div class="w-55">
                    <div class="form-control-wrap">
                      ...
                      <input type="text" id="edit-event-start-date" class="form-control date-picker" name="startDate"
                        data-date-format="yyyy-mm-dd" required>
                    </div>
                  </div>
                  <div class="w-45">
                    <div class="form-control-wrap">
                      ...
                      <input type="text" id="edit-event-start-time" data-time-format="HH:mm:ss" name="startTime"
                        class="form-control time-picker">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="w-45">
                    <div class="form-control-wrap">
                      ...
                      <input type="text" id="edit-event-end-time" data-time-format="HH:mm:ss"
                        class="form-control time-picker" readonly>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12">
              <div class="form-group">
                <label class="form-label" for="edit-event-description">Booking Description</label>
                <div class="form-control-wrap">
                  <textarea class="form-control" id="edit-event-description" name=""></textarea>
                </div>
              </div>
            </div>
            <div class="col-12">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul class="d-flex justify-content-between gx-4 mt-3">
          <li>
            <button data-dismiss="modal" data-toggle="modal" data-target="#editEventPopup" type="submit"
  ...
  NioApp.Calendar = function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      eventClick: function eventClick(info) {
        ...
        $('#edit-event-eventId').val(eventId);
      ...
      events: [
       @foreach($schedule as $event)
       {
        ...
        title: 'Day-Off',
        @elseif($event->type==5)
        title: "Booking {{ $event->bookingWCleanersSchedule->ref_no }}",
        @elseif($event->type==6)
        title: "Hiring {{ $event->bookingWCleanersSchedule->ref_no }}",
        @endif
        start:'{{ date("Y-m-d",strtotime($event->start_job)) }}T{{date("H:i:s",strtotime($event->start_job)) }}',
        end:'{{ date("Y-m-d",strtotime($event->end_job)) }}T{{date("H:i:s",strtotime($event->end_job)) }}',
        @if ($event->type==5)
        ...
        @endif
        description: "Cleaner JM-{{$event->userWCleanerSchedule->employeeWUser->code}} {{$event->userWCleanerSchedule->name}} "
      },
       @endforeach
      ]
    });
