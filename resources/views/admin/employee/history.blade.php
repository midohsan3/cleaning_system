        ...
        <div class="nk-block-head nk-block-head-sm">
          <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
              <h3 class="nk-block-title page-title">Employee Name /
              ...
              <div class="nk-block-des text-soft">
                <ul class="list-inline">
                  <li>{{ __('general.Submitted At') }}: <span
                      class="text-base">{{ date('d M, Y', strtotime($employee->created_at)) }}</span></li>
                </ul>
              </div>
            </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="tb-col-ip"><span class="sub-text">
                                {{ $action->employeeWEmployeeHistory->action }}
                              </span></td>
