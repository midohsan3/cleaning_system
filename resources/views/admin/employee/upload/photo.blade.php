          ...
          <div class="card card-preview">
            <div class="card-inner">
              <div class="preview-block">
                ...
                <form action="{{ route('admin.employee.photo.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                ...
                <div class="row gy-4">
                  ...
                  <div class="col col-md-4">
                    <div class="card">
                      <img src="{{ url('storage/app/public/imgs/users').'/'.$user->photo }}" class="card-img-top"
                        alt="{{ $user->photo }}" />
                    </div>
                  </div>
                  @else
