          ...
          <div class="card card-preview">
            <div class="card-inner">
              <div class="preview-block">
                ...
                <form action="{{ route('admin.employee.em.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                ...
                <div class="row gy-4">
                  @if (!empty($user->em_copy))
                  <div class="col col-md-4">
                    <div class="card">
                      <img src="{{ url('storage/app/public/imgs/users').'/'.$user->em_copy }}" class="card-img-top"
                        alt="{{ $user->em_copy }}" />
                    </div>
                  </div>
                  @else
