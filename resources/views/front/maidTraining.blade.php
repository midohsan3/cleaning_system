...
<div class="container-fluid page-header py-5" dir="ltr">
  <div class="container text-center py-5">
    <h1 class="display-2 text-white mb-4 animated slideInDown">{{ __('main.Maid Training') }}</h1>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb justify-content-center mb-0 animated slideInDown">
        <li class="breadcrumb-item"><a href="{{route('front')}}">{{ __('main.Home') }}</a></li>
        <li class="breadcrumb-item text-white" aria-current="page">{{ __('main.Maid Training') }}</li>
      </ol>
    </nav>
  </div>
</div>
    ...
    <div class="row g-5">
      <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".3s">
        <div class="about-img">
          ...
          <img src="{{url('imgs/serv2.jpg')}}" class="img-fluid h-100" alt="img">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".6s">
        <div class="about-item overflow-hidden">
          <h5 class="mb-2 px-3 py-1 text-dark rounded-pill d-inline-block border border-2 border-primary">
            {{ __('main.Service') }}</h5>
          <h1 class="display-5 mb-2">{{ __('main.Maid Training') }}</h1>
          <p class="fs-5" style="text-align: justify;">
            {{ __('main.Domestic staff are generally looked at someone to do your household chores, play with the kids, keep your homes, cars clean and also possess the knowledge to perform every task, be self-motivated and smile all the time. Well in our experience of training domestic staff for over 20 years in the UAE, only 3% fit the above-mentioned profile.') }}
          </p>
          <p class="fs-5" style="text-align: justify;">
            {{ __('main.The core focus of conducting this training program is to identify and focus on:') }}
          </p>
          <p class="fs-5" style="text-align: justify;">
            {{ __('main.The skills that the household staff may need to work on and to develop the same.') }}
          </p>
          <p class="fs-5" style="text-align: justify;">
            {{ __('main.Identify his/her key skills and enhance it even further to increase performance') }}
          </p>
