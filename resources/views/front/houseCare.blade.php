...
<div class="container-fluid page-header py-5" dir="ltr">
  <div class="container text-center py-5">
    <h1 class="display-2 text-white mb-4 animated slideInDown">{{ __('main.House Care') }}</h1>
    ...
    <div class="row g-5">
      <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".3s">
        <div class="about-img">
          ...
          <img src="{{url('imgs/serv1.jpg')}}" class="img-fluid h-100" alt="img">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".6s">
        <div class="about-item overflow-hidden">
          <h5 class="mb-2 px-3 py-1 text-dark rounded-pill d-inline-block border border-2 border-primary">
            {{ __('main.Service') }}</h5>
          <h1 class="display-5 mb-2">{{ __('main.House Care') }}</h1>
          <p class="fs-5" style="text-align: justify;">
            {{ __('main.JM-Cleaning Services, we understand the struggle of finding reliable cleaners you can trust. Our well-trained professionals are here to alleviate your worries and deliver exceptional cleaning standards tailored to your needs.') }}
          </p>
          <p class="fs-5" style="text-align: justify;">
