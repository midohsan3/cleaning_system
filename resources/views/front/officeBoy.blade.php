...
<div class="container-fluid page-header py-5" dir="ltr">
  <div class="container text-center py-5">
    <h1 class="display-2 text-white mb-4 animated slideInDown">{{ __('main.Office Boy') }}</h1>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb justify-content-center mb-0 animated slideInDown">
        <li class="breadcrumb-item"><a href="{{route('front')}}">{{ __('main.Home') }}</a></li>
        <li class="breadcrumb-item text-white" aria-current="page">{{ __('main.House Care') }}</li>
      </ol>
    </nav>
  </div>
</div>
    ...
    <div class="row g-5">
      <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".3s">
        <div class="about-img">
          ...
          <img src="{{url('imgs/serv77.jpg')}}" class="img-fluid h-100" alt="img">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".6s">
        <div class="about-item overflow-hidden">
          <h5 class="mb-2 px-3 py-1 text-dark rounded-pill d-inline-block border border-2 border-primary">
            {{ __('main.Service') }}</h5>
          <h1 class="display-5 mb-2">{{ __('main.Office Boy') }}</h1>
          <p class="fs-5" style="text-align: justify;">
            {{ __('main.At JM-Cleaning Service we understand how important it is to have a reliable and professional office boy/girl service. That is why we strive to provide the best service possible. We provide a wide range of office boy/girl services, including but not limited to assisting with day-to-day administrative tasks, stocking supplies and snacks, making coffee and tea, running errands, and providing general office support. Our experienced professionals are always available to help and complete any task quickly and efficiently.') }}
          </p>
