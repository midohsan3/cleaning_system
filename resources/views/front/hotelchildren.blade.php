...
<div class="container-fluid page-header py-5" dir="ltr">
  <div class="container text-center py-5">
    <h1 class="display-2 text-white mb-4 animated slideInDown">{{ __('main.Hotel Child Care') }}</h1>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb justify-content-center mb-0 animated slideInDown">
        <li class="breadcrumb-item"><a href="{{route('front')}}">{{ __('main.Home') }}</a></li>
        <li class="breadcrumb-item text-white" aria-current="page">{{ __('main.Hotel Child Care') }}</li>
      </ol>
    </nav>
  </div>
</div>
    ...
    <div class="row g-5">
      <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".3s">
        <div class="about-img">
          ...
          <img src="{{url('imgs/serv5.jpg')}}" class="img-fluid h-100" alt="img">
      ...
      <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".6s">
        <div class="about-item overflow-hidden">
          <h5 class="mb-2 px-3 py-1 text-dark rounded-pill d-inline-block border border-2 border-primary">
            {{ __('main.Service') }}</h5>
          <h1 class="display-5 mb-2">{{ __('main.Hotel Child Care') }}</h1>
          <p class="fs-5" style="text-align: justify;">
            {{ __('main.If youre a parent, you want to provide your kid with the most excellent possible care each and every day. Finding a trustworthy nurse would be a good first step in that case. Finding reliable babysitting and childcare services in Dubai might be a lifesaver. Its not uncommon for parents to seek out help for a variety of reasons. If you have to stay late at the office or need someone to watch the kids while you run errands, these services can help. It is essential, for whatever reason, to consult a reliable and professional babysitting services to take care of your kids at home.') }}
          </p>
          <p class="fs-5" style="text-align: justify;">
            {{ __('main.With us, you can rest assured that your home is in safe hands, allowing you to focus on your busy life without the stress of cleaning chores. Trust Alta Facilities for a spotless living space in Dubai.') }}
          </p>
